 ...
 * Genom att ha denna klassen kan vi ha en metod här som säger activateEffect().
 * Detta tillåter oss att spara alla effekter på samma ställe men endå lyckas utnyttja alla effekter effektivt.
 */
public abstract class Effect {
    private int id;

    public abstract void activateEffect(GameController gameController, PlayerID owner, Player player, boolean isPlayersTurn);
